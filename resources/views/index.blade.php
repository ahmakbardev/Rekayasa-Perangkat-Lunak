...
<body class="font-roboto">
    <!-- component -->
    <nav class="flex bg-slate-100 z-50 text-black items-center relative justify-between px-5 py-5 w-full">
        <div>
            <h1 class="text-xl font-semibold">BudayaNusantara</h1>
        </div>
        <ul id="drawer" role="menu"
            class="sm:gap-3 md:gap-8 transition-left ease-[cubic-bezier(0.4, 0.0, 0.2, 1)] delay-150  sm:flex  flex flex-col cursor-pointer absolute min-h-screen -left-48 sm:static w-48 top-0  sm:shadow-none shadow-xl sm:bg-transparent sm:flex-row sm:w-auto sm:min-h-0 ">
            ...
            <li
                class="font-medium text-sm p-3 cursor-pointer sm:p-0 sm:hover:bg-transparent hover:text-primary transition-colors">
                <a href="#" class="">Sumatra</a>
            </li>
            <li
                class="font-medium text-sm p-3 cursor-pointer sm:p-0 sm:hover:bg-transparent hover:text-primary transition-colors">
                <a href="#" class="">Kalimantan</a>
            </li>
            <li
                class="font-medium text-sm p-3 cursor-pointer sm:p-0 sm:hover:bg-transparent hover:text-primary transition-colors">
                <a href="#" class="">Sulawesi</a>
            </li>
        </ul>
        <div class="flex gap-3 items-center">
            <button
                class="text-white bg-[#EA580C] hover:ring-[#EA580C] hover:bg-transparent hover:ring-1 hover:text-[#EA580C] transition-all ease-in-out py-2 px-5 rounded-md">Belajar
                Sekarang</button>
            <svg width="24" height="24" class="hidden" viewBox="0 0 24 24" fill="none"
                xmlns="http://www.w3.org/2000/svg">
            ...
            <div
                class="hidden h-10 w-10 hover:ring-4 user cursor-pointer relative ring-blue-700/30 rounded-full bg-cover bg-center bg-[url('https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=80')]">
    ...
    <div class="flex gap-10 justify-between items-center py-10 px-20 relative">
        <div class="flex flex-col justify-center h-full gap-3 basis-1/2">
            <h1 class="text-6xl font-bold">BudayaNusantara</h1>
            <p class="text-lg">Selamat Datang di BudayaNusantara, Mari Menjelajahi Kekayaan Budaya Indonesia. Mulai
        ...
        <div class=" basis-2/5 relative overflow-visible">
            <img class="z-10 relative" src="{{ asset('assets/images/banner/head-1.png') }}" alt="">
        </div>
        <img class="absolute z-0 top-14 w-[50rem] right-10" src="{{ asset('assets/images/banner/head-2.png') }}"
            alt="">
    </div>
    <div class="flex flex-col gap-3 py-10 px-20 items-center">
        <h1 class="text-5xl font-bold">Tahukah Kamu?</h1>
        <h1 class="text-xl font-medium w-1/2 text-center">Tiap Daerah yang ada di Indonesia memiliki budaya yang
            berbeda dan sangat keren lo?! Mau tahu apa saja? Pelajari Sekarang!</h1>
        <div class="grid grid-cols-4 gap-3">
            <div class="p-3 rounded-lg border shadow-md flex flex-col gap-2">
                <span class="py-1 px-2 bg-green-500 rounded-full text-xs font-semibold w-fit text-white">NEW</span>
                <img class="w-3/4 mx-auto" src="{{ asset('assets/images/daerah/jawa.png') }}" alt="">
                <p class="text-lg font-semibold">Pulau Jawa</p>
                <a href="{{ route('flipbook') }}"
                    class="text-center ring-1 py-2 rounded-md ring-sky-400 hover:ring-2 transition-all ease-in-out font-semibold text-sm">Belajar
                    Sekarang</a>
            </div>
            <div class="p-3 rounded-lg border shadow-md flex flex-col gap-2 relative overflow-hidden group">
                ...
                <span class="py-1 px-2 bg-yellow-500 rounded-full text-xs font-semibold w-fit text-white">Coming
                    Soon</span>
                <img class="w-3/4 mx-auto" src="{{ asset('assets/images/daerah/sumatra.png') }}" alt="">
                <p class="text-lg font-semibold">Pulau Sumatra</p>
                <button
